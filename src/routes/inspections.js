...
router.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    try {
      ...
      if (error) {
        logger.error('Inspections list error:', error);
        throw new AppError('Erro ao carregar vistorias');
      }

      const totalPages = Math.ceil(count / limit);

      logger.debug('Inspections listed', {
        userId: user.id,
...
router.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    try {
      ...
      logger.debug('Inspection retrieved', {
        userId: user.id,
        inspectionId: id,
        companyId: user.company_id
      });
      ...
      logger.error('Inspection get error:', error);
...
router.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    try {
      ...
      if (error) {
        logger.error('Inspection creation error:', error);
...
router.delete(
  ...
  asyncHandler(async (req, res) => {
    ...
    try {
      ...
      if (deleteError) {
        logger.error('Inspection deletion error:', deleteError);
      ...
      logger.error('Inspection deletion error:', error);
      throw new AppError('Erro ao excluir vistoria');
    }
  })
);
