...
const reportSchemas = {
  ...
  city: z.string(),
  state: z.string(),
  includeInspections: z.boolean().transform(val => val === true || val === 'true')
};
...
router.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    try {
      ...
      if (error) {
        logger.error('Inspections report error:', error);
      ...
      logger.info('Inspections report generated', {
        userId: user.id,
        userRole: user.role,
...
router.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    try {
      ...
      if (error) {
        logger.error('Properties report error:', error);
      ...
      logger.info('Properties report generated', {
        userId: user.id,
...
router.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    try {
      ...
      if (inspectionsError) {
        logger.error('Performance report inspections error:', inspectionsError);
      ...
      if (contestsError) {
        logger.error('Performance report contests error:', contestsError);
