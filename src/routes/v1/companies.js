...
router.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    if (error) {
      ...
      logger.error('Error creating portal user:', error);
      throw new AppError('Erro ao criar membro da empresa', 500);
    }

    logger.info('Company member created successfully', {
      memberId: member.id,
      companyId: id,
...
router.put(
  ...
  asyncHandler(async (req, res) => {
    ...
    logger.info('Company member updated successfully', {
      memberId,
      companyId: id,
...
router.delete(
  ...
  asyncHandler(async (req, res) => {
    ...
    if (deleteError) {
      logger.error('Error deleting company member:', deleteError);
